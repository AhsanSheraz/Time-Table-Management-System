  ...
  <div class="navbar navbar-inverse navbar-fixed-top">
	...
	print_r($e[$k-1]['sem_name']);
		?>">Current Time Table</a></li>
          ...
          <li class="nav-item active"><a href="registerS.php">Register Semester</a></li>
      ...
      <div class="col-md-6 col-md-offset-3" id="topPage">
        <form class="padTop"  method="post">
          <?php
            ...
            $chk->registerSem();
          ?>
          <label class="clr" for="semId">Enter Semester Name For Registeration</label>
          <input type="text" name="sID" title="enter semester id" class="form-control" placeholder="Semester Name">
          <h4>(<b>Hint:</b>i.e:2017F/S)</h4>
          <input type="submit" name="submit" class="btn btn-success btn-lg padTop" title="click to Register...!!" value="Register">
        </form>
      </div>
    </div>
  </div>
