	...
	print_r($e[$k-1]['sem_name']);
		?>">Current Time Table</a></li>
          ...
          <li  class="nav-item active dropdown"><a href="" title="Time Table" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Room<span class="caret"></span></a>
            <ul class="dropdown-menu">
            <li class="nav-item active"><a href="addroom1.php" title="Add Room">Add Room</a></li>
            <li><a href="updater.php">Update Room</a></li>
      ...
      <div class="col-md-6 col-md-offset-3" id="topPage">
        <form class="padTop"  method="post">
          <?php
            ...
            $chk->registerRoom();
          ?>
          <label class="clr" for="room">Enter Room Name</label>
          <input type="text" name="addroom" title="enter room number" class="form-control" placeholder="Room Name">
          <h4>(<b>Hint:</b>i.e:R201)</h4>
          <input type="submit" title="Click to Add room!" value="Add Room" name="submit" class="btn btn-success btn-lg padTop">
        </form>
      </div>
    </div>
  </div>
