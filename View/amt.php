	...
	print_r($e[$k-1]['sem_name']);
		?>">Current Time Table</a></li>
          ...
          <li  class="nav-item active dropdown"><a href="" title="Time Table" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Message<span class="caret"></span></a>
            <ul class="dropdown-menu">
            <li class="nav-item active"><a href="amt.php" title="Send to Teacher">Send to Teacher</a></li>
    ...
    <div class="row">
      <div class="col-md-6 col-md-offset-3" id="topPage">
        <form class="padTop"  method="post">
          ...
          <input type="text" name="subject" title="enter subject here" class="form-control" placeholder="Enter Subject">
          ...
          <input type="submit" name="submit" class="btn btn-success btn-lg padTop" title="Click to Send Message!" value="Send to Teacher">
      </div>
    </div>
  </div>
