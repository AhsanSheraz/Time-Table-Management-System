    ...
    <div class="container-fluid ">
      ...
      <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
          <li  class="nav-item active"><a href="teacherp.php" title="Home"><span class="glyphicon glyphicon-home"></span> Home</a></li>
  ...
  <div class="container contentContainer" id="topContainer">
    <div class="row">
      <div class="col-md-6 col-md-offset-3" id="topPage">
        <h1 class="padTop">Welcome To Teacher Panel</h1>
        <p class="bold lead" id="col">Hello Teachers.</p>
        <p id="col">Teachers you can view time tables here and receive messages from Admin related to class cancellation and staff meetings.</p>
      </div>
    </div>
  </div>
