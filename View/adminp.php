    ...
    <div class="container-fluid ">
      ...
      <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
          <li  class="nav-item  active"><a href="adminp.php" title="Home"><span class="glyphicon glyphicon-home"></span> Home</a></li>
	...
	print_r($e[$k-1]['sem_name']);
		?>">Current Time Table</a></li>
          ...
          <li  class="nav-item dropdown"><a href="" title="Room" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Room<span class="caret"></span></a>
           ...
           <li><a href="login.php?logout=1" class="m" title="Log Out!">Log out</a></li>
         </ul>
  ...
  <div class="container contentContainer" id="topContainer">
    <div class="row">
      <div class="col-md-6 col-md-offset-3" id="topPage">
        <h1 class="padTop">Welcome To Admin Panel</h1>
        <p class="bold lead" id="col">Hello Admin.</p>
        <p id="col">Admin you can manage time table here and send messages to students and teachers.</p>
      </div>
    </div>
  </div>
