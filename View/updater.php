	...
	print_r($e[$k-1]['sem_name']);
		?>">Current Time Table</a></li>
          ...
          <li  class="nav-item active dropdown"><a href="" title="Time Table" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Room<span class="caret"></span></a>
            ...
            <li class="nav-item active"><a href="updater.php">Update Room</a></li>
      ...
      <div class="col-md-6 col-md-offset-3" id="topPage">
        <form class="padTop"  method="post">
          <?php
            ...
            $chk->updateRoom();
          ?>
          <label class="clr" for="room">Enter Old Room Name</label>
          <input type="text" name="oldroom" title="enter room number" class="form-control" placeholder="Room Name">
          <h4>(<b>Hint:</b>i.e:R201)</h4>
          <label class="clr1" for="room">Enter New Room Name</label>
          <input type="text" name="newroom" title="enter room number" class="form-control" placeholder="Room Name">
          <h4>(<b>Hint:</b>i.e:R201)</h4>
          <input type="submit" title="Click to Update room!" value="Update Room" name="submit" class="btn btn-success btn-lg padTop">
